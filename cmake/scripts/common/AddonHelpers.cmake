...
macro (build_addon target prefix libs)
  ...
  if(${prefix}_SOURCES)
    ...
    message(STATUS "Addon API check ...")
    # Set defines used in addon.xml.in and read from version.h to set add-on
    # version parts automatically
    file(STRINGS ${KODI_INCLUDE_DIR}/c-api/version.h BIN_ADDON_PARTS)
  ...
  if(PACKAGE_ZIP OR PACKAGE_TGZ)
    ...
    if(WIN32)
      ...
      if(${prefix}_ADDITIONAL_BINARY)
        install(PROGRAMS ${${prefix}_ADDITIONAL_BINARY} DESTINATION ${target}
                COMPONENT ${target}-${${prefix}_VERSION}-${PLATFORM_TAG})
      endif()
    ...
    if(${prefix}_ADDITIONAL_BINARY)
      install(PROGRAMS ${${prefix}_ADDITIONAL_BINARY} DESTINATION ${CMAKE_INSTALL_LIBDIR}/addons/${target})
    endif()
    if(${prefix}_ADDITIONAL_BINARY_EXE)
