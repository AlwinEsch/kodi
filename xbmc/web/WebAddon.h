...
public:
  ...
  WEB_ADDON_ERROR ControlCreate(const WEB_ADDON_GUI_PROPS& props,
                                ...
                                WEB_HANDLE handle);
  bool DestroyControl(const WEB_HANDLE handle, bool complete);
  void Render(const WEB_HANDLE handle);
  bool Dirty(const WEB_HANDLE handle);
  bool OnInit(const WEB_HANDLE handle);
  bool OnAction(
      const WEB_HANDLE handle, const addon_action_data* action, int& nextItem);
  bool OnMouseEvent(const WEB_HANDLE handle,
                    int id,
                    double x,
                    double y,
                    double offsetX,
                    double offsetY,
                    int state);
  bool ControlGetHistory(const WEB_HANDLE handle,
                         std::vector<std::string>& historyWebsiteNames,
                         bool behindCurrent);
  void ControlSearchText(const WEB_HANDLE handle,
                         const std::string& text,
                         bool forward,
                         bool matchCase,
                         bool findNext);
  void ControlStopSearch(const WEB_HANDLE handle, bool clearSelection);
   ...
   */
  //@{
  bool OpenWebsite(const WEB_HANDLE handle, const std::string& url);
  void Reload(const WEB_HANDLE handle);
  void StopLoad(const WEB_HANDLE handle);
  void GoBack(const WEB_HANDLE handle);
  void GoForward(const WEB_HANDLE handle);
  void OpenOwnContextMenu(const WEB_HANDLE handle);
  //@}
