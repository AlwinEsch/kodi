...
#define WEB_CONDITIONS_START 1050
#define WEB_HAS_ADDONS (WEB_CONDITIONS_START)
#define WEB_HAS_BROWSER (WEB_CONDITIONS_START + 1)
#define WEB_CONDITIONS_END WEB_HAS_BROWSER

#define WEB_CONTROL_START 1070
#define WEB_CONTROL_OPENED_ADDRESS (WEB_CONTROL_START)
#define WEB_CONTROL_OPENED_TITLE (WEB_CONTROL_START + 1)
#define WEB_CONTROL_ICONURL (WEB_CONTROL_START + 2)
#define WEB_CONTROL_IS_LOADING (WEB_CONTROL_START + 3)
#define WEB_CONTROL_CAN_GO_BACK (WEB_CONTROL_START + 4)
#define WEB_CONTROL_CAN_GO_FORWARD (WEB_CONTROL_START + 5)
#define WEB_CONTROL_TOOLTIP (WEB_CONTROL_START + 6)
#define WEB_CONTROL_STATUS_MESSAGE (WEB_CONTROL_START + 7)
#define WEB_CONTROL_END WEB_CONTROL_STATUS_MESSAGE
