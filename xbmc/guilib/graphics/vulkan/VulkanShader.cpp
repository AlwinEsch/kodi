...
bool CShader::LoadSource(const std::string& filename, const std::string& prefix)
{
  ...
  //if (!file.Open(path))
  //{
  //  CLog::Log(LOGERROR, "CYUVShaderVulkanSL::CYUVShaderVulkanSL - failed to open file {}",
  //            filename);
  //  return false;
  //}
...
//////////////////////////////////////////////////////////////////////
// CVulkanSLVertexShader
//////////////////////////////////////////////////////////////////////

bool CVulkanSLVertexShader::Compile()
{
  //GLint params[4];
...
void CVulkanSLVertexShader::Free()
{
  //if (m_vertexShader)
...
//////////////////////////////////////////////////////////////////////
// CVulkanSLPixelShader
//////////////////////////////////////////////////////////////////////
bool CVulkanSLPixelShader::Compile()
{
  //GLint params[4];
...
void CVulkanSLPixelShader::Free()
{
  //if (m_pixelShader)
...
//////////////////////////////////////////////////////////////////////
CVulkanSLShaderProgram::CVulkanSLShaderProgram()
{
  //m_pFP = new CVulkanSLPixelShader();
  //m_pVP = new CVulkanSLVertexShader();
}

CVulkanSLShaderProgram::CVulkanSLShaderProgram(const std::string& vert, const std::string& frag)
{
  //m_pFP = new CVulkanSLPixelShader();
...
void CVulkanSLShaderProgram::Free()
{
  //m_pVP->Free();
  //VerifyVulkanState();
  //m_pFP->Free();
...
bool CVulkanSLShaderProgram::CompileAndLink()
{
  //GLint params[4];
...
void CVulkanSLShaderProgram::Disable()
{
  //if (OK())
  //{
  //  glUseProgram(0);
