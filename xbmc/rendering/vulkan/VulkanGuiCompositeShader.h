...
class CVulkanGuiCompositeShader : public KODI::GUILIB::GRAPHICS::VULKAN::CVulkanSLShaderProgram
{
public:
  explicit CVulkanGuiCompositeShader(const std::string& prefix);
  ~CVulkanGuiCompositeShader() override;
