...
CVulkanShaderFonts::CVulkanShaderFonts(const VulkanData* vkData, CVulkanDeviceQueue* deviceQueue)
...
void CVulkanShaderFonts::UpdateUniformBuffer(uint32_t index, const VulkanUniform& uniformData)
{
