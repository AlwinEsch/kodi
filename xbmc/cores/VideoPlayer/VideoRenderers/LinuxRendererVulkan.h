...
class CLinuxRendererVulkan : public CBaseRenderer
{
public:
  CLinuxRendererVulkan();
  ~CLinuxRendererVulkan() override;
...
//
  ...
  Shaders::VULKAN::BaseYUV2RGBVulkanShader* m_pYUVProgShader{nullptr};
  Shaders::VULKAN::BaseYUV2RGBVulkanShader* m_pYUVBobShader{nullptr};
  Shaders::VULKAN::BaseVideoFilterShader* m_pVideoFilterShader{nullptr};
