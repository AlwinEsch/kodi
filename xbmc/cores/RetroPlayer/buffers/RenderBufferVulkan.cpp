...
CRenderBufferVulkan::CRenderBufferVulkan(CRenderContext& context,
                                         GLuint pixelType,
...
CRenderBufferVulkan::~CRenderBufferVulkan()
{
  DeleteTexture();
}

void CRenderBufferVulkan::CreateTexture()
{
...
bool CRenderBufferVulkan::UploadTexture()
{
...
void CRenderBufferVulkan::DeleteTexture()
{
  if (glIsTexture(m_textureId))
