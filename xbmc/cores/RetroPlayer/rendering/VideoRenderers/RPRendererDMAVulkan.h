...
class CRendererFactoryDMAVulkan : public IRendererFactory
{
public:
  ~CRendererFactoryDMAVulkan() override = default;
 ...
 *        CBufferObject types.
 */
class CRPRendererDMAVulkan : public CRPRendererVulkan
{
public:
  CRPRendererDMAVulkan(const CRenderSettings& renderSettings,
                         CRenderContext& context,
                         std::shared_ptr<IRenderBufferPool> bufferPool);
  ~CRPRendererDMAVulkan() override = default;

protected:
  // Implementation of CRPRendererVulkan
