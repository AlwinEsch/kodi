...
// --- CRendererFactoryDMAVulkan ------------------------------------------------

std::string CRendererFactoryDMAVulkan::RenderSystemName() const
{
  return "DMAVulkan";
}

CRPBaseRenderer* CRendererFactoryDMAVulkan::CreateRenderer(
    const CRenderSettings& settings,
    CRenderContext& context,
    std::shared_ptr<IRenderBufferPool> bufferPool)
{
  return new CRPRendererDMAVulkan(settings, context, std::move(bufferPool));
}

RenderBufferPoolVector CRendererFactoryDMAVulkan::CreateBufferPools(CRenderContext& context)
{
...
CRPRendererDMAVulkan::CRPRendererDMAVulkan(const CRenderSettings& renderSettings,
                                               CRenderContext& context,
                                               std::shared_ptr<IRenderBufferPool> bufferPool)
  : CRPRendererVulkan(renderSettings, context, std::move(bufferPool))
{
}

void CRPRendererDMAVulkan::Render(uint8_t alpha)
{
