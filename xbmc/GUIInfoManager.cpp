...
///
/// -----------------------------------------------------------------------------
constexpr std::array<InfoMap, 2> web = {{
    {"hasaddons",        WEB_HAS_ADDONS},
...
///
/// -----------------------------------------------------------------------------
constexpr std::array<InfoMap, 8> webcontrol = {{
    {"openedaddress",    WEB_CONTROL_OPENED_ADDRESS},
