                                           ...
                                           msgpack::sbuffer& out)
{
  ...
  switch (func)
  {
    ...
    {
      // Original API call: ATTR_DLL_EXPORT bool kodi_vfs_file_io_ctl_set_cache_rate(KODI_FILE_HDL hdl, uint32_t rate) __INTRODUCED_IN_KODI(1);
      // Tuple in:          typedef std::tuple<PtrValue, uint32_t> msgParent__IN_kodi_vfs_file_io_ctl_set_cache_rate_v1; /* Autogenerated */
                                                       ...
                                                       size_t* num_items)
{
  ...
  if (fileItems.Size() > 0)
  {
    ...
    *items = static_cast<VFS_DIR_ENTRY*>(calloc(fileItems.Size(), sizeof(VFS_DIR_ENTRY)));
