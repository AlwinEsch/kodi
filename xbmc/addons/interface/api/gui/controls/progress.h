...
class CHdl_kodi_gui_controls_progress_h : public IMsgHdl
{
public:
  CHdl_kodi_gui_controls_progress_h(CInterface& interface) : IMsgHdl(interface) {}

  void InitDirect(directFuncToKodi_gui_controls_progress_h* ifcToKodi,
...
private:
  ...
  static void kodi_gui_controls_progress_set_visible_v1(void* thisClassHdl,
                                                        KODI_GUI_CONTROL_HANDLE handle,
                                                        bool visible); // Added with API 1

  static void kodi_gui_controls_progress_set_percentage_v1(void* thisClassHdl,
                                                           KODI_GUI_CONTROL_HANDLE handle,
                                                           float percent); // Added with API 1

  static float kodi_gui_controls_progress_get_percentage_v1(
      void* thisClassHdl, KODI_GUI_CONTROL_HANDLE handle); // Added with API 1

  directFuncToAddon_gui_controls_progress_h* m_ifcToAddon{nullptr};
};
