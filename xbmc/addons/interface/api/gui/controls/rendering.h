...
class CHdl_kodi_gui_controls_rendering_h : public IMsgHdl
{
public:
  CHdl_kodi_gui_controls_rendering_h(CInterface& interface) : IMsgHdl(interface) {}

  void InitDirect(directFuncToKodi_gui_controls_rendering_h* ifcToKodi,
...
private:
  ...
  static void kodi_gui_controls_radio_rendering_destroy_v1(
      void* thisClassHdl, KODI_GUI_CONTROL_HANDLE handle); // Added with API 1

  directFuncToAddon_gui_controls_rendering_h* m_ifcToAddon{nullptr};
};
