                                            ...
                                            msgpack::sbuffer& out)
{
  ...
  switch (func)
  {
    ...
    case funcParent_kodi_gui_get_hw_context_v1:
    {
      ...
      ADDON_HARDWARE_CONTEXT auto_gen_ret = kodi_gui_get_hw_context_v1(this);
...
ADDON_HARDWARE_CONTEXT CHdl_kodi_gui_general_h::kodi_gui_get_hw_context_v1(void* thisClassHdl)
{
  auto thisClass = reinterpret_cast<CHdl_kodi_gui_general_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return nullptr;
