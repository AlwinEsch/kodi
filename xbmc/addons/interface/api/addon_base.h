...
public:
  ...
  static bool UpdateSettingInActiveDialog(const std::string& addonId,
                                          const std::string& id,
  ...
  enum ADDON_STATUS kodi_addon_create_instance_v1(const KODI_ADDON_HDL hdl,
  ...
  enum ADDON_STATUS kodi_addon_instance_setting_change_string_v1(
      const KODI_ADDON_HDL hdl,
      const KODI_ADDON_INSTANCE_HDL instance_hdl,
      const char* name,
      const char* value); // Added with API 1

  enum ADDON_STATUS kodi_addon_instance_setting_change_boolean_v1(
      const KODI_ADDON_HDL hdl,
      const KODI_ADDON_INSTANCE_HDL instance_hdl,
      const char* name,
      bool value); // Added with API 1

  enum ADDON_STATUS kodi_addon_instance_setting_change_integer_v1(
      const KODI_ADDON_HDL hdl,
      const KODI_ADDON_INSTANCE_HDL instance_hdl,
      const char* name,
      int value); // Added with API 1

  enum ADDON_STATUS kodi_addon_instance_setting_change_float_v1(
      const KODI_ADDON_HDL hdl,
      const KODI_ADDON_INSTANCE_HDL instance_hdl,
      const char* name,
      double value); // Added with API 1

  KODI_ADDON_INSTANCE_HDL kodi_addon_instance_create_v1(
      KODI_ADDON_INSTANCE_BACKEND_HDL kodi_hdl); // Added with API 1

  void kodi_addon_instance_destroy_v1(KODI_ADDON_INSTANCE_HDL hdl); // Added with API 1
...
private:
  ...
  static char* kodi_addon_get_addon_path_v1(void* thisClassHdl); // Added with API 1
  ...
  static char* kodi_addon_localized_string_v1(void* thisClassHdl,
                                              long label_id); // Added with API 1
  ...
  static char* kodi_addon_instance_get_user_path_v1(
      void* thisClassHdl, const KODI_ADDON_INSTANCE_BACKEND_HDL hdl); // Added with API 1

  static bool kodi_addon_instance_is_setting_using_default_v1(
      void* thisClassHdl,
      const KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
      const char* id); // Added with API 1

  static bool kodi_addon_instance_get_setting_bool_v1(void* thisClassHdl,
                                                      const KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                      const char* id,
                                                      bool* value); // Added with API 1

  static bool kodi_addon_instance_get_setting_int_v1(void* thisClassHdl,
                                                     const KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                     const char* id,
                                                     int* value); // Added with API 1

  static bool kodi_addon_instance_get_setting_float_v1(void* thisClassHdl,
                                                       const KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                       const char* id,
                                                       double* value); // Added with API 1

  static bool kodi_addon_instance_get_setting_string_v1(void* thisClassHdl,
                                                        const KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                        const char* id,
                                                        char** value); // Added with API 1

  static bool kodi_addon_instance_set_setting_bool_v1(void* thisClassHdl,
                                                      const KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                      const char* id,
                                                      bool value); // Added with API 1

  static bool kodi_addon_instance_set_setting_int_v1(void* thisClassHdl,
                                                     const KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                     const char* id,
                                                     int value); // Added with API 1

  static bool kodi_addon_instance_set_setting_float_v1(void* thisClassHdl,
                                                       const KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                       const char* id,
                                                       double value); // Added with API 1

  static bool kodi_addon_instance_set_setting_string_v1(void* thisClassHdl,
                                                        const KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                        const char* id,
                                                        const char* value); // Added with API 1
