...
public:
  ...
  bool kodi_addon_visualization_start_v1(IOffscreenRenderProcess* proc,
  ...
  void kodi_addon_visualization_stop_v1(IOffscreenRenderProcess* proc,
                                        const KODI_ADDON_VISUALIZATION_HDL hdl); // Added with API 1

  int kodi_addon_visualization_get_sync_delay_v1(
      const KODI_ADDON_VISUALIZATION_HDL hdl); // Added with API 1

  void kodi_addon_visualization_audio_data_v1(const KODI_ADDON_VISUALIZATION_HDL hdl,
                                              const float* audio_data,
                                              size_t audio_data_length); // Added with API 1

  bool kodi_addon_visualization_is_dirty_v1(
      const KODI_ADDON_VISUALIZATION_HDL hdl); // Added with API 1

  void kodi_addon_visualization_render_v1(
      IOffscreenRenderProcess* proc, const KODI_ADDON_VISUALIZATION_HDL hdl); // Added with API 1
  ...
  bool kodi_addon_visualization_load_preset_v1(const KODI_ADDON_VISUALIZATION_HDL hdl,
  ...
  bool kodi_addon_visualization_rate_preset_v1(const KODI_ADDON_VISUALIZATION_HDL hdl,
                                               bool plus_minus); // Added with API 1

  bool kodi_addon_visualization_is_locked_v1(
      const KODI_ADDON_VISUALIZATION_HDL hdl); // Added with API 1

  bool kodi_addon_visualization_update_albumart_v1(const KODI_ADDON_VISUALIZATION_HDL hdl,
                                                   const char* albumart); // Added with API 1

  bool kodi_addon_visualization_update_track_v1(
      const KODI_ADDON_VISUALIZATION_HDL hdl,
...
private:
  ...
  static void kodi_addon_visualization_get_properties_v1(
      ...
      struct KODI_ADDON_VISUALIZATION_PROPS* props); // Added with API 1

  static void kodi_addon_visualization_transfer_preset_v1(void* thisClassHdl,
                                                          const KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                          const char* preset); // Added with API 1

  static void kodi_addon_visualization_clear_presets_v1(
