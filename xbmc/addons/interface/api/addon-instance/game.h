...
public:
  ...
  KODI_ADDON_GAME_HDL kodi_addon_game_create_v1(
  ...
  enum GAME_ERROR kodi_addon_game_rc_generate_hash_from_file_v1(
      const KODI_ADDON_GAME_HDL hdl,
      char** hash,
      unsigned int console_id,
      const char* file_path); // Added with API 1

  enum GAME_ERROR kodi_addon_game_rc_get_game_id_url_v1(const KODI_ADDON_GAME_HDL hdl,
                                                        char** url,
                                                        const char* hash); // Added with API 1

  enum GAME_ERROR kodi_addon_game_rc_get_patch_file_url_v1(
      const KODI_ADDON_GAME_HDL hdl,
      char** url,
      const char* username,
      const char* token,
  ...
  enum GAME_ERROR kodi_addon_game_rc_post_rich_presence_url_v1(
      const KODI_ADDON_GAME_HDL hdl,
      char** url,
      char** post_data,
      const char* username,
  ...
  enum GAME_ERROR kodi_addon_game_rc_enable_rich_presence_v1(
      const KODI_ADDON_GAME_HDL hdl, const char* script); // Added with API 1

  enum GAME_ERROR kodi_addon_game_rc_get_rich_presence_evaluation_v1(
      const KODI_ADDON_GAME_HDL hdl,
      char** evaluation,
      unsigned int console_id); // Added with API 1

  enum GAME_ERROR kodi_addon_game_rc_reset_runtime_v1(
      const KODI_ADDON_GAME_HDL hdl); // Added with API 1
...
private:
  ...
  static void kodi_addon_game_close_v1(void* thisClassHdl,
  ...
  static game_proc_address_t kodi_addon_game_hw_get_proc_address_v1(
      void* thisClassHdl,
      KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
      const char* symbol); // Added with API 1
