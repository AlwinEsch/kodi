...
{
  // Original API call: typedef KODI_ADDON_PERIPHERAL_HDL(ATTR_APIENTRYP PFN_KODI_ADDON_PERIPHERAL_CREATE_V1)(KODI_ADDON_INSTANCE_BACKEND_HDL kodi_hdl);
...
void CHdl_kodi_addoninstance_peripheral_h::kodi_addon_peripheral_trigger_scan_v1(
