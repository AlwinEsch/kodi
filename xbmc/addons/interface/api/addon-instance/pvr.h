...
private:
  ...
  static int kodi_addon_pvr_get_epg_max_future_days_v1(
      void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl); // Added with API 1

  static int kodi_addon_pvr_get_epg_max_past_days_v1(
      void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl); // Added with API 1
  ...
  static void kodi_addon_pvr_transfer_provider_entry_v1(
      ...
      KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
      const KODI_ADDON_PVR_TRANSFER_HDL handle,
      const struct PVR_PROVIDER* chanProvider); // Added with API 1
  ...
  static void kodi_addon_pvr_trigger_channel_update_v1(
      void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl); // Added with API 1

  static void kodi_addon_pvr_trigger_providers_update_v1(
      void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl); // Added with API 1

  static void kodi_addon_pvr_trigger_channel_groups_update_v1(
      void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl); // Added with API 1
  ...
  static void kodi_addon_pvr_trigger_recording_update_v1(
      void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl); // Added with API 1

  static void kodi_addon_pvr_trigger_timer_update_v1(
      void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl); // Added with API 1
