    ...
    const char* song_name)
{
  ...
  if (!m_interface.m_directDll)
  {
    ...
    msgpack::pack(in, msgChild__IN_kodi_addon_visualization_start_v1(
                          ...
                          PtrValue(context), PtrValue(hdl), channels, samples_per_sec,
                          bits_per_sample, song_name));
...
void CHdl_kodi_addoninstance_visualization_h::kodi_addon_visualization_stop_v1(
    IOffscreenRenderProcess* proc, const KODI_ADDON_VISUALIZATION_HDL hdl)
{
  ...
  if (!m_interface.m_directDll)
  {
    ...
    msgpack::sbuffer in;
    msgpack::pack(in, msgChild__IN_kodi_addon_visualization_stop_v1(proc->GetAddonOffscreenHdl(),
                                                                    PtrValue(hdl)));
    ...
    const KODI_ADDON_VISUALIZATION_HDL hdl)
{
  ...
  if (!m_interface.m_directDll)
  {
    msgpack::sbuffer in;
    msgpack::sbuffer out;
    msgpack::pack(in, msgChild__IN_kodi_addon_visualization_get_sync_delay_v1(PtrValue(hdl)));
    if (!m_process->SendMessage(funcGroup_addoninstance_visualization_h,
                                funcChild_kodi_addon_visualization_get_sync_delay_v1, in, out))
      return -1;
    msgpack::unpacked ident = msgpack::unpack(out.data(), out.size());
    msgChild_OUT_kodi_addon_visualization_get_sync_delay_v1 t = ident.get().as<decltype(t)>();
    return std::get<0>(t);
  }
#endif /* !KODI_INHIBIT_SHARED */

  return m_ifcToAddon->kodi_addon_visualization_get_sync_delay_v1(m_ifcToAddon->thisClassHdl, hdl);
}
    ...
    const KODI_ADDON_VISUALIZATION_HDL hdl, const float* audio_data, size_t audio_data_length)
{
  ...
  if (!m_interface.m_directDll)
  {
    msgpack::sbuffer in;
    msgpack::pack(in,
                  msgChild__IN_kodi_addon_visualization_audio_data_v1(
  ...
  m_ifcToAddon->kodi_addon_visualization_audio_data_v1(m_ifcToAddon->thisClassHdl, hdl, audio_data,
                                                       audio_data_length);
}
    ...
    IOffscreenRenderProcess* proc, const KODI_ADDON_VISUALIZATION_HDL hdl)
{
  ...
  if (!m_interface.m_directDll)
  {
    ...
    msgpack::sbuffer in;
    msgpack::pack(in, msgChild__IN_kodi_addon_visualization_render_v1(proc->GetAddonOffscreenHdl(),
                                                                      PtrValue(hdl)));
    m_process->SendMessage(funcGroup_addoninstance_visualization_h,
    ...
    struct KODI_ADDON_VISUALIZATION_PROPS* props)
{
  ...
  // AUTOGENERATED - Used by class "KODI::ADDONS::CVisualization" with "void get_properties(KODI_ADDON_VISUALIZATION_PROPS* props)" on "addons/Visualization.h".

  KODI::ADDONS::CVisualization* cb = static_cast<KODI::ADDONS::CVisualization*>(hdl);
...
void CHdl_kodi_addoninstance_visualization_h::kodi_addon_visualization_transfer_preset_v1(
    void* thisClassHdl, const KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const char* preset)
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_visualization_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return;
  ...
  // AUTOGENERATED - Used by class "KODI::ADDONS::CVisualization" with "void transfer_preset(const char* preset)" on "addons/Visualization.h".
    ...
    void* thisClassHdl, const KODI_ADDON_INSTANCE_BACKEND_HDL hdl)
{
  ...
  // AUTOGENERATED - Used by class "KODI::ADDONS::CVisualization" with "void clear_presets()" on "addons/Visualization.h".
