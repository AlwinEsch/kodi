...
int CHdl_kodi_addoninstance_pvr_h::kodi_addon_pvr_get_epg_max_future_days_v1(
    void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl)
{
...
int CHdl_kodi_addoninstance_pvr_h::kodi_addon_pvr_get_epg_max_past_days_v1(
    void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl)
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_pvr_h*>(thisClassHdl);
  if (thisClass == nullptr)
...
void CHdl_kodi_addoninstance_pvr_h::kodi_addon_pvr_add_menu_hook_v1(
    void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const struct PVR_MENUHOOK* hook)
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_pvr_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return;
    ...
    const struct PVR_PROVIDER* chanProvider)
{
  ...
  // AUTOGENERATED - Used by class "PVR::CPVRClient" with "void cb_transfer_provider_entry(const KODI_ADDON_PVR_TRANSFER_HDL handle, const PVR_PROVIDER* entry)" on "pvr/addons/PVRClient.h".
...
void CHdl_kodi_addoninstance_pvr_h::kodi_addon_pvr_trigger_channel_update_v1(
    void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl)
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_pvr_h*>(thisClassHdl);
  if (thisClass == nullptr)
...
void CHdl_kodi_addoninstance_pvr_h::kodi_addon_pvr_trigger_providers_update_v1(
    void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl)
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_pvr_h*>(thisClassHdl);
  if (thisClass == nullptr)
  ...
  // AUTOGENERATED - Used by class "PVR::CPVRClient" with "void cb_trigger_provider_update()" on "pvr/addons/PVRClient.h".

  PVR::CPVRClient* cb = static_cast<PVR::CPVRClient*>(hdl);
  cb->cb_trigger_provider_update();
...
void CHdl_kodi_addoninstance_pvr_h::kodi_addon_pvr_trigger_epg_update_v1(
    void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl, unsigned int iChannelUid)
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_pvr_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return;
...
void CHdl_kodi_addoninstance_pvr_h::kodi_addon_pvr_trigger_recording_update_v1(
    void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl)
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_pvr_h*>(thisClassHdl);
  if (thisClass == nullptr)
...
void CHdl_kodi_addoninstance_pvr_h::kodi_addon_pvr_trigger_timer_update_v1(
    void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl)
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_pvr_h*>(thisClassHdl);
  if (thisClass == nullptr)
