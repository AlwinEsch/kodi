...
{
  // Original API call: typedef KODI_ADDON_INPUTSTREAM_HDL(ATTR_APIENTRYP PFN_KODI_ADDON_INPUTSTREAM_CREATE_V1)(KODI_ADDON_INSTANCE_BACKEND_HDL kodi_hdl);
...
void CHdl_kodi_addoninstance_inputstream_h::kodi_addon_inputstream_free_demux_packet_v1(
    void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL hdl, struct DEMUX_PACKET* packet)
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_inputstream_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return;
