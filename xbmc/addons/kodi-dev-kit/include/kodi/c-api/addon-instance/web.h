...
extern "C"
{
  ...
  struct WEB_ADDON_GUI_PROPS;
  struct AddonInstance_WebAddon;

  /*!
   * @brief Handle used to return data from the Web add-on to CWebAddon
   */
  struct WEB_HANDLE_STRUCT
  {
  ...
  typedef struct WEB_HANDLE_STRUCT* WEB_HANDLE;

  typedef struct WEB_CONTROL_HANDLE
  {
    struct WEB_HANDLE_STRUCT ownHandle;
  ...
  typedef struct WEB_ADDON_GUI_PROPS
  {
     ...
     * must set by callback functions on WEB_HANDLE::dataAddress with this!
     */
    WEB_KODI_CONTROL pControlIdent;
  } WEB_ADDON_GUI_PROPS;

  typedef struct AddonProps_WebAddon /* internal */
  {
  ...
  typedef struct AddonToKodiFuncTable_WebAddon /* internal */
  {
  ...
  typedef struct KodiToAddonFuncTable_WebAddon /* internal */
  {
  ...
  typedef struct AddonInstance_WebAddon /* internal */
  {
