...
extern "C"
{
  ...
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_GET_SETTING_FLOAT_V1)(const char*, double*);
  ...
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_INSTANCE_GET_SETTING_BOOL_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, bool*);
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_INSTANCE_GET_SETTING_FLOAT_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, double*);
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_INSTANCE_GET_SETTING_INT_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, int*);
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_INSTANCE_GET_SETTING_STRING_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, char**);
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_INSTANCE_IS_SETTING_USING_DEFAULT_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL, const char*);
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_INSTANCE_SET_SETTING_BOOL_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, bool);
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_INSTANCE_SET_SETTING_FLOAT_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, double);
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_INSTANCE_SET_SETTING_INT_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, int);
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_INSTANCE_SET_SETTING_STRING_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, const char*);
  ...
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_SET_SETTING_FLOAT_V1)(const char*, double);
  ...
  typedef char*(ATTR_DL_APIENTRYP PFN_KODI_ADDON_GET_ADDON_PATH_V1)();
  ...
  typedef char*(ATTR_DL_APIENTRYP PFN_KODI_ADDON_INSTANCE_GET_USER_PATH_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL);
  typedef char*(ATTR_DL_APIENTRYP PFN_KODI_ADDON_LOCALIZED_STRING_V1)(long);
  ...
  typedef ssize_t(ATTR_DL_APIENTRYP PFN_KODI_ADDON_AUDIOENCODER_SEEK_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, ssize_t, int);
  typedef ssize_t(ATTR_DL_APIENTRYP PFN_KODI_ADDON_AUDIOENCODER_WRITE_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, const uint8_t*, size_t);

  // addon-instance/game.h
  typedef KODI_GAME_STREAM_HANDLE(ATTR_DL_APIENTRYP PFN_KODI_ADDON_GAME_OPEN_STREAM_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, const struct game_stream_properties*);
  ...
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_GAME_INPUT_EVENT_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, const struct game_input_event*);
  typedef game_proc_address_t(ATTR_DL_APIENTRYP PFN_KODI_ADDON_GAME_HW_GET_PROC_ADDRESS_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, const char*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_GAME_ADD_STREAM_DATA_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, KODI_GAME_STREAM_HANDLE, const struct game_stream_packet*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_GAME_CLOSE_STREAM_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, KODI_GAME_STREAM_HANDLE);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_GAME_CLOSE_V1)(KODI_ADDON_INSTANCE_BACKEND_HDL);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_GAME_RELEASE_STREAM_BUFFER_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, KODI_GAME_STREAM_HANDLE, struct game_stream_buffer*);

  // addon-instance/inputstream.h
  typedef struct DEMUX_PACKET*(
      ATTR_DL_APIENTRYP PFN_KODI_ADDON_INPUTSTREAM_ALLOCATE_DEMUX_PACKET_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, int);
  typedef struct DEMUX_PACKET*(
      ATTR_DL_APIENTRYP PFN_KODI_ADDON_INPUTSTREAM_ALLOCATE_ENCRYPTED_DEMUX_PACKET_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, unsigned int, unsigned int);
  ...
  typedef enum JOYSTICK_FEATURE_TYPE(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PERIPHERAL_FEATURE_TYPE_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, const char*);
  typedef unsigned int(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PERIPHERAL_FEATURE_COUNT_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, enum JOYSTICK_FEATURE_TYPE);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PERIPHERAL_REFRESH_BUTTON_MAPS_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, const char*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PERIPHERAL_TRIGGER_SCAN_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL);

  // addon-instance/pvr.h
  typedef int(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_GET_EPG_MAX_FUTURE_DAYS_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL);
  typedef int(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_GET_EPG_MAX_PAST_DAYS_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_ADD_MENU_HOOK_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, const struct PVR_MENUHOOK*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_CONNECTION_STATE_CHANGE_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, enum PVR_CONNECTION_STATE, const char*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_EPG_EVENT_STATE_CHANGE_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, struct EPG_TAG*, enum EPG_EVENT_STATE);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_RECORDING_NOTIFICATION_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, const char*, bool);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_TRANSFER_CHANNEL_ENTRY_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL,
      const KODI_ADDON_PVR_TRANSFER_HDL,
      const struct PVR_CHANNEL*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_TRANSFER_CHANNEL_GROUP_MEMBER_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL,
      const KODI_ADDON_PVR_TRANSFER_HDL,
      const struct PVR_CHANNEL_GROUP_MEMBER*);
  ...
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_TRANSFER_EPG_ENTRY_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, const KODI_ADDON_PVR_TRANSFER_HDL, const struct EPG_TAG*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_TRANSFER_PROVIDER_ENTRY_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL,
      const KODI_ADDON_PVR_TRANSFER_HDL,
      const struct PVR_PROVIDER*);
  ...
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_TRANSFER_TIMER_ENTRY_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, const KODI_ADDON_PVR_TRANSFER_HDL, const struct PVR_TIMER*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_TRIGGER_CHANNEL_GROUPS_UPDATE_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_TRIGGER_CHANNEL_UPDATE_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_TRIGGER_EPG_UPDATE_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, unsigned int);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_TRIGGER_PROVIDERS_UPDATE_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_TRIGGER_RECORDING_UPDATE_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_PVR_TRIGGER_TIMER_UPDATE_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL);

  // addon-instance/screensaver.h
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_SCREENSAVER_GET_PROPERTIES_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL, struct KODI_ADDON_SCREENSAVER_PROPS*);

  // addon-instance/vfs.h
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_VFS_GET_DIR_CB__GET_KEYBOARD_INPUT_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, KODI_CTX_CB_HDL, const char*, char**, bool);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_VFS_GET_DIR_CB__REQUIRE_AUTHENTICATION_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, KODI_CTX_CB_HDL, const char*);
  ...
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_VIDEOCODEC_GET_FRAME_BUFFER_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, struct VIDEOCODEC_PICTURE*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_VIDEOCODEC_RELEASE_FRAME_BUFFER_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, struct VIDEOCODEC_PICTURE*);

  // addon-instance/visualization.h
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_VISUALIZATION_CLEAR_PRESETS_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_VISUALIZATION_GET_PROPERTIES_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL, struct KODI_ADDON_VISUALIZATION_PROPS*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_VISUALIZATION_TRANSFER_PRESET_V1)(
      const KODI_ADDON_INSTANCE_BACKEND_HDL, const char*);

  // addon-instance/web.h
  typedef bool(ATTR_DL_APIENTRYP PFN_KODI_ADDON_WEB_IS_MUTED_V1)(KODI_ADDON_INSTANCE_BACKEND_HDL);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_WEB_CONTROL_REQUEST_OPEN_SITE_IN_NEW_TAB_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, WEB_KODI_CONTROL, const char*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_WEB_CONTROL_SET_CONTROL_READY_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, WEB_KODI_CONTROL, bool);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_WEB_CONTROL_SET_FULLSCREEN_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, WEB_KODI_CONTROL, bool);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_WEB_CONTROL_SET_ICON_URL_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, WEB_KODI_CONTROL, const char*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_WEB_CONTROL_SET_LOADING_STATE_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, WEB_KODI_CONTROL, bool, bool, bool);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_WEB_CONTROL_SET_OPENED_ADDRESS_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, WEB_KODI_CONTROL, const char*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_WEB_CONTROL_SET_OPENED_TITLE_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, WEB_KODI_CONTROL, const char*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_WEB_CONTROL_SET_STATUS_MESSAGE_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, WEB_KODI_CONTROL, const char*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_WEB_CONTROL_SET_TOOLTIP_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, WEB_KODI_CONTROL, const char*);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_WEB_INHIBIT_SCREENSAVER_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, bool);
  typedef void(ATTR_DL_APIENTRYP PFN_KODI_ADDON_WEB_INHIBIT_SHUTDOWN_V1)(
      KODI_ADDON_INSTANCE_BACKEND_HDL, bool);

  // gui/general.h
  typedef ADDON_HARDWARE_CONTEXT(ATTR_DL_APIENTRYP PFN_KODI_GUI_GET_HW_CONTEXT_V1)();
  ...
  {
    // addon_base.h
    PFN_KODI_ADDON_GET_ADDON_PATH_V1 kodi_addon_get_addon_path;
    ...
    PFN_KODI_ADDON_INSTANCE_GET_SETTING_BOOL_V1 kodi_addon_instance_get_setting_bool;
    PFN_KODI_ADDON_INSTANCE_GET_SETTING_FLOAT_V1 kodi_addon_instance_get_setting_float;
    PFN_KODI_ADDON_INSTANCE_GET_SETTING_INT_V1 kodi_addon_instance_get_setting_int;
    PFN_KODI_ADDON_INSTANCE_GET_SETTING_STRING_V1 kodi_addon_instance_get_setting_string;
    PFN_KODI_ADDON_INSTANCE_GET_USER_PATH_V1 kodi_addon_instance_get_user_path;
    PFN_KODI_ADDON_INSTANCE_IS_SETTING_USING_DEFAULT_V1
        kodi_addon_instance_is_setting_using_default;
    PFN_KODI_ADDON_INSTANCE_SET_SETTING_BOOL_V1 kodi_addon_instance_set_setting_bool;
    PFN_KODI_ADDON_INSTANCE_SET_SETTING_FLOAT_V1 kodi_addon_instance_set_setting_float;
    PFN_KODI_ADDON_INSTANCE_SET_SETTING_INT_V1 kodi_addon_instance_set_setting_int;
    PFN_KODI_ADDON_INSTANCE_SET_SETTING_STRING_V1 kodi_addon_instance_set_setting_string;
    PFN_KODI_ADDON_IS_SETTING_USING_DEFAULT_V1 kodi_addon_is_setting_using_default;
    PFN_KODI_ADDON_LOCALIZED_STRING_V1 kodi_addon_localized_string;
    ...
    PFN_KODI_ADDON_PVR_TRIGGER_PROVIDERS_UPDATE_V1 kodi_addon_pvr_trigger_providers_update;
    ...
    // addon-instance/web.h
    PFN_KODI_ADDON_WEB_CONTROL_REQUEST_OPEN_SITE_IN_NEW_TAB_V1
        kodi_addon_web_control_request_open_site_in_new_tab;
    PFN_KODI_ADDON_WEB_CONTROL_SET_CONTROL_READY_V1 kodi_addon_web_control_set_control_ready;
    PFN_KODI_ADDON_WEB_CONTROL_SET_FULLSCREEN_V1 kodi_addon_web_control_set_fullscreen;
    PFN_KODI_ADDON_WEB_CONTROL_SET_ICON_URL_V1 kodi_addon_web_control_set_icon_url;
    PFN_KODI_ADDON_WEB_CONTROL_SET_LOADING_STATE_V1 kodi_addon_web_control_set_loading_state;
    PFN_KODI_ADDON_WEB_CONTROL_SET_OPENED_ADDRESS_V1 kodi_addon_web_control_set_opened_address;
    PFN_KODI_ADDON_WEB_CONTROL_SET_OPENED_TITLE_V1 kodi_addon_web_control_set_opened_title;
    PFN_KODI_ADDON_WEB_CONTROL_SET_STATUS_MESSAGE_V1 kodi_addon_web_control_set_status_message;
    PFN_KODI_ADDON_WEB_CONTROL_SET_TOOLTIP_V1 kodi_addon_web_control_set_tooltip;
    PFN_KODI_ADDON_WEB_INHIBIT_SCREENSAVER_V1 kodi_addon_web_inhibit_screensaver;
    PFN_KODI_ADDON_WEB_INHIBIT_SHUTDOWN_V1 kodi_addon_web_inhibit_shutdown;
    PFN_KODI_ADDON_WEB_IS_MUTED_V1 kodi_addon_web_is_muted;
