...
struct IFC_VFS_CACHE_STATUS
{
  ...
  MSGPACK_DEFINE(forward, maxrate, currate, lowrate);
};
...
typedef std::tuple<PtrValue, uint32_t> msgParent__IN_kodi_vfs_file_io_ctl_set_cache_rate_v1; /* Autogenerated */
