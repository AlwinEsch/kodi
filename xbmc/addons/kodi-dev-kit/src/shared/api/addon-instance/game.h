...
typedef struct KODI_ADDON_GAME_FUNC_V1_TO_V1
{
  ...
  PFN_KODI_ADDON_GAME_RC_GENERATE_HASH_FROM_FILE_V1
      rc_generate_hash_from_file; /*---AUTO<EQUAL_FROM_TO:1_1>---*/
  PFN_KODI_ADDON_GAME_RC_GET_GAME_ID_URL_V1 rc_get_game_id_url; /*---AUTO<EQUAL_FROM_TO:1_1>---*/
  PFN_KODI_ADDON_GAME_RC_GET_PATCH_FILE_URL_V1
      rc_get_patch_file_url; /*---AUTO<EQUAL_FROM_TO:1_1>---*/
  PFN_KODI_ADDON_GAME_RC_POST_RICH_PRESENCE_URL_V1
      rc_post_rich_presence_url; /*---AUTO<EQUAL_FROM_TO:1_1>---*/
  PFN_KODI_ADDON_GAME_RC_ENABLE_RICH_PRESENCE_V1
      rc_enable_rich_presence; /*---AUTO<EQUAL_FROM_TO:1_1>---*/
  PFN_KODI_ADDON_GAME_RC_GET_RICH_PRESENCE_EVALUATION_V1
      rc_get_rich_presence_evaluation; /*---AUTO<EQUAL_FROM_TO:1_1>---*/
  PFN_KODI_ADDON_GAME_RC_RESET_RUNTIME_V1 rc_reset_runtime; /*---AUTO<EQUAL_FROM_TO:1_1>---*/
...
typedef KODI_GAME_STREAM_HANDLE(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_OPEN_STREAM_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL, const struct game_stream_properties*);
...
typedef bool(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_INPUT_EVENT_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL, const struct game_input_event*);
typedef game_proc_address_t(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_HW_GET_PROC_ADDRESS_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL, const char*);
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_ADD_STREAM_DATA_V1)(
    void*,
    KODI_ADDON_INSTANCE_BACKEND_HDL,
    KODI_GAME_STREAM_HANDLE,
    const struct game_stream_packet*);
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_CLOSE_STREAM_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL, KODI_GAME_STREAM_HANDLE);
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_CLOSE_V1)(void*,
                                                                  KODI_ADDON_INSTANCE_BACKEND_HDL);
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_RELEASE_STREAM_BUFFER_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL, KODI_GAME_STREAM_HANDLE, struct game_stream_buffer*);
...
struct directFuncToKodi_addoninstance_game_h
{
  ...
  PFN_INT_KODI_ADDON_GAME_HW_GET_PROC_ADDRESS_V1 kodi_addon_game_hw_get_proc_address_v1;
...
typedef KODI_ADDON_GAME_HDL(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_CREATE_V1)(
...
typedef enum GAME_ERROR(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_LOAD_STANDALONE_V1)(
    void*, const KODI_ADDON_GAME_HDL);
typedef enum GAME_ERROR(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_RC_ENABLE_RICH_PRESENCE_V1)(
    void*, const KODI_ADDON_GAME_HDL, const char*);
typedef enum GAME_ERROR(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_RC_GENERATE_HASH_FROM_FILE_V1)(
    void*, const KODI_ADDON_GAME_HDL, char**, unsigned int, const char*);
typedef enum GAME_ERROR(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_RC_GET_GAME_ID_URL_V1)(
    void*, const KODI_ADDON_GAME_HDL, char**, const char*);
typedef enum GAME_ERROR(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_RC_GET_PATCH_FILE_URL_V1)(
    void*, const KODI_ADDON_GAME_HDL, char**, const char*, const char*, unsigned int);
typedef enum GAME_ERROR(
    ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_RC_GET_RICH_PRESENCE_EVALUATION_V1)(
    void*, const KODI_ADDON_GAME_HDL, char**, unsigned int);
typedef enum GAME_ERROR(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_RC_POST_RICH_PRESENCE_URL_V1)(
    void*,
    const KODI_ADDON_GAME_HDL,
    char**,
    char**,
    ...
    unsigned int,
    const char*);
typedef enum GAME_ERROR(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_GAME_RC_RESET_RUNTIME_V1)(
    void*, const KODI_ADDON_GAME_HDL);
...
struct directFuncToAddon_addoninstance_game_h
{
  ...
  PFN_INT_KODI_ADDON_GAME_RC_ENABLE_RICH_PRESENCE_V1 kodi_addon_game_rc_enable_rich_presence_v1;
  PFN_INT_KODI_ADDON_GAME_RC_GENERATE_HASH_FROM_FILE_V1
      kodi_addon_game_rc_generate_hash_from_file_v1;
  PFN_INT_KODI_ADDON_GAME_RC_GET_GAME_ID_URL_V1 kodi_addon_game_rc_get_game_id_url_v1;
  PFN_INT_KODI_ADDON_GAME_RC_GET_PATCH_FILE_URL_V1 kodi_addon_game_rc_get_patch_file_url_v1;
  PFN_INT_KODI_ADDON_GAME_RC_GET_RICH_PRESENCE_EVALUATION_V1
      kodi_addon_game_rc_get_rich_presence_evaluation_v1;
  PFN_INT_KODI_ADDON_GAME_RC_POST_RICH_PRESENCE_URL_V1 kodi_addon_game_rc_post_rich_presence_url_v1;
  PFN_INT_KODI_ADDON_GAME_RC_RESET_RUNTIME_V1 kodi_addon_game_rc_reset_runtime_v1;
