...
typedef ssize_t(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_AUDIOENCODER_SEEK_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL, ssize_t, int);
typedef ssize_t(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_AUDIOENCODER_WRITE_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL, const uint8_t*, size_t);
...
typedef bool(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_AUDIOENCODER_START_V1)(
    void*, KODI_ADDON_AUDIOENCODER_HDL, const struct KODI_ADDON_AUDIOENCODER_INFO_TAG*);
...
struct IFC_KODI_ADDON_AUDIOENCODER_INFO_TAG
{
  IFC_KODI_ADDON_AUDIOENCODER_INFO_TAG() = default;
  IFC_KODI_ADDON_AUDIOENCODER_INFO_TAG(const KODI_ADDON_AUDIOENCODER_INFO_TAG* c_data)
  {
    if (c_data == nullptr)
      return;
  ...
  void SetCStructure(KODI_ADDON_AUDIOENCODER_INFO_TAG* c_data)
  {
    if (c_data == nullptr)
      return;
...
typedef std::tuple<PtrValue, ssize_t, int> msgParent__IN_kodi_addon_audioencoder_seek_v1; /* Autogenerated */
...
typedef std::tuple<PtrValue, IFC_KODI_ADDON_AUDIOENCODER_INFO_TAG> msgChild__IN_kodi_addon_audioencoder_start_v1; /* Autogenerated */
