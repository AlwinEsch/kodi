...
struct IFC_PVR_ADDON_CAPABILITIES
{
  ...
  IFC_PVR_ADDON_CAPABILITIES(const PVR_ADDON_CAPABILITIES* c_data)
  {
    ...
    bSupportsProviders = c_data->bSupportsProviders;
    bSupportsRecordingsDelete = c_data->bSupportsRecordingsDelete;
  ...
  void SetCStructure(PVR_ADDON_CAPABILITIES* c_data)
  {
    ...
    c_data->bSupportsProviders = bSupportsProviders;
    c_data->bSupportsRecordingsDelete = bSupportsRecordingsDelete;
