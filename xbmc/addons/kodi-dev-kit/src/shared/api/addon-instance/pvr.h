...
#include "src/shared/api/addon-instance/pvr/pvr_providers.h"
...
typedef struct KODI_ADDON_PVR_FUNC_V1_TO_V1
{
  ...
  PFN_KODI_ADDON_PVR_GET_PROVIDERS_AMOUNT_V1 get_providers_amount; /*---AUTO<EQUAL_FROM_TO:1_1>---*/
  PFN_KODI_ADDON_PVR_GET_PROVIDERS_V1 get_providers; /*---AUTO<EQUAL_FROM_TO:1_1>---*/
...
typedef int(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_GET_EPG_MAX_FUTURE_DAYS_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL);
typedef int(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_GET_EPG_MAX_PAST_DAYS_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL);
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_ADD_MENU_HOOK_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL, const struct PVR_MENUHOOK*);
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_CONNECTION_STATE_CHANGE_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, enum PVR_CONNECTION_STATE, const char*);
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_EPG_EVENT_STATE_CHANGE_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL, struct EPG_TAG*, enum EPG_EVENT_STATE);
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_RECORDING_NOTIFICATION_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL, const char*, const char*, bool);
...
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_TRANSFER_PROVIDER_ENTRY_V1)(
    void*,
    KODI_ADDON_INSTANCE_BACKEND_HDL,
    const KODI_ADDON_PVR_TRANSFER_HDL,
...
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_TRIGGER_CHANNEL_GROUPS_UPDATE_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL);
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_TRIGGER_CHANNEL_UPDATE_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL);
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_TRIGGER_EPG_UPDATE_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL, unsigned int);
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_TRIGGER_PROVIDERS_UPDATE_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL);
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_TRIGGER_RECORDING_UPDATE_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL);
typedef void(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_TRIGGER_TIMER_UPDATE_V1)(
    void*, KODI_ADDON_INSTANCE_BACKEND_HDL);
...
struct directFuncToKodi_addoninstance_pvr_h
{
  ...
  PFN_INT_KODI_ADDON_PVR_TRANSFER_PROVIDER_ENTRY_V1 kodi_addon_pvr_transfer_provider_entry_v1;
  ...
  PFN_INT_KODI_ADDON_PVR_TRIGGER_PROVIDERS_UPDATE_V1 kodi_addon_pvr_trigger_providers_update_v1;
...
typedef enum PVR_ERROR(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_GET_PROVIDERS_AMOUNT_V1)(
    void*, KODI_ADDON_PVR_HDL, int*);
typedef enum PVR_ERROR(ATTR_INT_APIENTRYP PFN_INT_KODI_ADDON_PVR_GET_PROVIDERS_V1)(
...
struct directFuncToAddon_addoninstance_pvr_h
{
  ...
  PFN_INT_KODI_ADDON_PVR_GET_PROVIDERS_AMOUNT_V1 kodi_addon_pvr_get_providers_amount_v1;
  PFN_INT_KODI_ADDON_PVR_GET_PROVIDERS_V1 kodi_addon_pvr_get_providers_v1;
...
typedef enum funcParent_addoninstance_pvr_h : int
{
  ...
  funcParent_kodi_addon_pvr_trigger_providers_update_v1,
...
typedef std::tuple<PtrValue, PtrValue, IFC_PVR_PROVIDER> msgParent__IN_kodi_addon_pvr_transfer_provider_entry_v1; /* Autogenerated */
typedef std::tuple<DummyValue> msgParent_OUT_kodi_addon_pvr_transfer_provider_entry_v1; /* Autogenerated */
...
typedef std::tuple<PtrValue> msgParent__IN_kodi_addon_pvr_trigger_providers_update_v1; /* Autogenerated */
typedef std::tuple<DummyValue> msgParent_OUT_kodi_addon_pvr_trigger_providers_update_v1; /* Autogenerated */
...
typedef enum funcChild_addoninstance_pvr_h : int
{
  ...
  funcChild_kodi_addon_pvr_get_providers_amount_v1,
  funcChild_kodi_addon_pvr_get_providers_v1,
...
typedef std::tuple<PtrValue, int> msgChild__IN_kodi_addon_pvr_get_providers_amount_v1; /* Autogenerated */
typedef std::tuple<PVR_ERROR, int> msgChild_OUT_kodi_addon_pvr_get_providers_amount_v1; /* Autogenerated */
...
typedef std::tuple<PtrValue, PtrValue> msgChild__IN_kodi_addon_pvr_get_providers_v1; /* Autogenerated */
typedef std::tuple<PVR_ERROR> msgChild_OUT_kodi_addon_pvr_get_providers_v1; /* Autogenerated */
