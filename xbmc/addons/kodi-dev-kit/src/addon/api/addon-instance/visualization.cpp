    ...
    directFuncToAddon_addoninstance_visualization_h* ifcToAddon)
{
  ...
  ifcToAddon->kodi_addon_visualization_get_sync_delay_v1 =
      kodi_addon_visualization_get_sync_delay_v1;
                                                            ...
                                                            msgpack::sbuffer& out)
{
  ...
  switch (func)
  {
    case funcChild_kodi_addon_visualization_start_v1:
    {
      ...
      // Tuple in:          typedef std::tuple<PtrKodiOffscreen, uint64_t, int, int, int, int, PtrValue /* < Offscreen render */, PtrValue, int, int, int, std::string> msgChild__IN_kodi_addon_visualization_start_v1; /* Autogenerated */
      // Tuple out:         typedef std::tuple<bool, PtrAddonOffscreen, bool /* < Offscreen render */> msgChild_OUT_kodi_addon_visualization_start_v1; /* Autogenerated */
      ...
      const KODI_ADDON_VISUALIZATION_HDL hdl =
          reinterpret_cast<KODI_ADDON_VISUALIZATION_HDL>(std::get<7>(t));
      int channels = std::get<8>(t);
      int samples_per_sec = std::get<9>(t);
      int bits_per_sample = std::get<10>(t);
      const std::string& song_name = std::get<11>(t);
      bool auto_gen_ret = kodi_addon_visualization_start_v1(this, hdl, channels, samples_per_sec,
                                                            bits_per_sample, song_name.c_str());

      msgpack::pack(
          out, msgChild_OUT_kodi_addon_visualization_start_v1(
    ...
    case funcChild_kodi_addon_visualization_stop_v1:
    {
      ...
      // Tuple in:          typedef std::tuple<PtrAddonOffscreen /* < Offscreen render */, PtrValue> msgChild__IN_kodi_addon_visualization_stop_v1; /* Autogenerated */
      ...
      const KODI_ADDON_VISUALIZATION_HDL hdl =
          reinterpret_cast<KODI_ADDON_VISUALIZATION_HDL>(std::get<1>(t));
      kodi_addon_visualization_stop_v1(this, hdl);
    ...
    case funcChild_kodi_addon_visualization_get_sync_delay_v1:
    {
      ...
      // Tuple in:          typedef std::tuple<PtrValue> msgChild__IN_kodi_addon_visualization_get_sync_delay_v1; /* Autogenerated */
      // Tuple out:         typedef std::tuple<int> msgChild_OUT_kodi_addon_visualization_get_sync_delay_v1; /* Autogenerated */

      msgChild__IN_kodi_addon_visualization_get_sync_delay_v1 t = in.get().as<decltype(t)>();
      KODI_ADDON_HDL auto_gen_hdl = reinterpret_cast<KODI_ADDON_HDL>(std::get<0>(t));

      int auto_gen_ret = kodi_addon_visualization_get_sync_delay_v1(this, auto_gen_hdl);

      msgpack::pack(out, msgChild_OUT_kodi_addon_visualization_get_sync_delay_v1(auto_gen_ret));
      return true;
    }
    case funcChild_kodi_addon_visualization_audio_data_v1:
    {
      ...
      // Tuple in:          typedef std::tuple<PtrValue, std::vector<float>, size_t> msgChild__IN_kodi_addon_visualization_audio_data_v1; /* Autogenerated */
    ...
    case funcChild_kodi_addon_visualization_render_v1:
    {
      ...
      // Tuple in:          typedef std::tuple<PtrAddonOffscreen /* < Offscreen render */, PtrValue> msgChild__IN_kodi_addon_visualization_render_v1; /* Autogenerated */
      ...
      const KODI_ADDON_VISUALIZATION_HDL hdl =
          reinterpret_cast<KODI_ADDON_VISUALIZATION_HDL>(std::get<1>(t));
      kodi_addon_visualization_render_v1(this, hdl);
    ...
    case funcChild_kodi_addon_visualization_update_track_v1:
    {
      ...
      // Tuple in:          typedef std::tuple<PtrValue, IFC_KODI_ADDON_VISUALIZATION_TRACK> msgChild__IN_kodi_addon_visualization_update_track_v1; /* Autogenerated */
...
void CHdl_kodi_addoninstance_visualization_h::kodi_addon_visualization_stop_v1(
    void* thisClassHdl, const KODI_ADDON_VISUALIZATION_HDL hdl) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_visualization_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return;
...
int CHdl_kodi_addoninstance_visualization_h::kodi_addon_visualization_get_sync_delay_v1(
    void* thisClassHdl, const KODI_ADDON_VISUALIZATION_HDL hdl) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_visualization_h*>(thisClassHdl);
  if (thisClass == nullptr)
  ...
  UnionAddonFunctions* union_data = reinterpret_cast<UnionAddonFunctions*>(hdl);
  int auto_gen_ret = -1;
  if (union_data->types.kodi_addon_visualization.v1.get_sync_delay)
  {
    auto_gen_ret = union_data->types.kodi_addon_visualization.v1.get_sync_delay(union_data->hdl);
  }
  return auto_gen_ret;
}
...
void CHdl_kodi_addoninstance_visualization_h::kodi_addon_visualization_audio_data_v1(
    ...
    size_t audio_data_length) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_visualization_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return;
  ...
  {
    union_data->types.kodi_addon_visualization.v1.audio_data(union_data->hdl, audio_data,
                                                             audio_data_length);
  }
}
...
bool CHdl_kodi_addoninstance_visualization_h::kodi_addon_visualization_load_preset_v1(
    void* thisClassHdl, const KODI_ADDON_VISUALIZATION_HDL hdl, int select) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_visualization_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return false;
...
bool CHdl_kodi_addoninstance_visualization_h::kodi_addon_visualization_rate_preset_v1(
    void* thisClassHdl, const KODI_ADDON_VISUALIZATION_HDL hdl, bool plus_minus) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_visualization_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return false;
...
bool CHdl_kodi_addoninstance_visualization_h::kodi_addon_visualization_update_track_v1(
    void* thisClassHdl,
    const KODI_ADDON_VISUALIZATION_HDL hdl,
    const struct KODI_ADDON_VISUALIZATION_TRACK* track) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_visualization_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return false;
...
ATTR_DLL_EXPORT void kodi_addon_visualization_get_properties(
    const KODI_ADDON_INSTANCE_BACKEND_HDL hdl, struct KODI_ADDON_VISUALIZATION_PROPS* props)
{
  ...
  // Tuple out:         typedef std::tuple<IFC_KODI_ADDON_VISUALIZATION_PROPS> msgParent_OUT_kodi_addon_visualization_get_properties_v1; /* Autogenerated */
...
ATTR_DLL_EXPORT void kodi_addon_visualization_transfer_preset(
    const KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const char* preset)
{
...
ATTR_DLL_EXPORT void kodi_addon_visualization_clear_presets(
