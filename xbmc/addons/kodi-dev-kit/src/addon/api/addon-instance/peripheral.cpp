...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_peripheral_trigger_scan(KODI_ADDON_INSTANCE_BACKEND_HDL hdl) __INTRODUCED_IN_KODI(1);
  if (hdl == nullptr)
    return;
...
ATTR_DLL_EXPORT void kodi_addon_peripheral_refresh_button_maps(KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                               const char* device_name,
                                                               const char* controller_id)
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_peripheral_refresh_button_maps( KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const char* device_name, const char* controller_id) __INTRODUCED_IN_KODI(1);
...
ATTR_DLL_EXPORT unsigned int kodi_addon_peripheral_feature_count(
    KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const char* controller_id, enum JOYSTICK_FEATURE_TYPE type)
{
  // Original API call: ATTR_DLL_EXPORT unsigned int kodi_addon_peripheral_feature_count( KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const char* controller_id, enum JOYSTICK_FEATURE_TYPE type) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT enum JOYSTICK_FEATURE_TYPE kodi_addon_peripheral_feature_type( KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const char* controller_id, const char* feature_name) __INTRODUCED_IN_KODI(1);
