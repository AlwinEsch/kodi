...
{
  // Original API call: ATTR_DLL_EXPORT bool kodi_addon_videocodec_get_frame_buffer(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, struct VIDEOCODEC_PICTURE* picture) __INTRODUCED_IN_KODI(1);
...
ATTR_DLL_EXPORT void kodi_addon_videocodec_release_frame_buffer(KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                                struct VIDEOCODEC_PICTURE* picture)
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_videocodec_release_frame_buffer( KODI_ADDON_INSTANCE_BACKEND_HDL hdl, struct VIDEOCODEC_PICTURE* picture) __INTRODUCED_IN_KODI(1);
  if (hdl == nullptr || picture == nullptr)
    return;
