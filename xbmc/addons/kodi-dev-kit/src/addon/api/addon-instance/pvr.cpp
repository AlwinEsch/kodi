...
void CHdl_kodi_addoninstance_pvr_h::InitDirect(directFuncToAddon_addoninstance_pvr_h* ifcToAddon)
{
  ...
  ifcToAddon->kodi_addon_pvr_get_providers_amount_v1 = kodi_addon_pvr_get_providers_amount_v1;
  ifcToAddon->kodi_addon_pvr_get_providers_v1 = kodi_addon_pvr_get_providers_v1;
                                                  ...
                                                  msgpack::sbuffer& out)
{
  ...
  switch (func)
  {
    ...
    case funcChild_kodi_addon_pvr_get_providers_amount_v1:
    {
      ...
      msgChild__IN_kodi_addon_pvr_get_providers_amount_v1 t = in.get().as<decltype(t)>();
      KODI_ADDON_HDL auto_gen_hdl = reinterpret_cast<KODI_ADDON_HDL>(std::get<0>(t));
      int amount = std::get<1>(t);
      enum PVR_ERROR auto_gen_ret =
          kodi_addon_pvr_get_providers_amount_v1(this, auto_gen_hdl, &amount);

      msgpack::pack(out, msgChild_OUT_kodi_addon_pvr_get_providers_amount_v1(auto_gen_ret, amount));
      return true;
    }
    case funcChild_kodi_addon_pvr_get_providers_v1:
    {
      ...
      msgChild__IN_kodi_addon_pvr_get_providers_v1 t = in.get().as<decltype(t)>();
      KODI_ADDON_HDL auto_gen_hdl = reinterpret_cast<KODI_ADDON_HDL>(std::get<0>(t));
      KODI_ADDON_PVR_TRANSFER_HDL handle =
          reinterpret_cast<KODI_ADDON_PVR_TRANSFER_HDL>(std::get<1>(t));
      enum PVR_ERROR auto_gen_ret = kodi_addon_pvr_get_providers_v1(this, auto_gen_hdl, handle);

      msgpack::pack(out, msgChild_OUT_kodi_addon_pvr_get_providers_v1(auto_gen_ret));
      return true;
    }
    ...
    void* thisClassHdl, KODI_ADDON_PVR_HDL hdl, int* amount) // Added with API 1
{
  ...
  UnionAddonFunctions* union_data = reinterpret_cast<UnionAddonFunctions*>(hdl);
  enum PVR_ERROR auto_gen_ret = PVR_ERROR_NO_ERROR;
  if (union_data->types.kodi_addon_pvr.v1.get_providers_amount)
  {
    auto_gen_ret =
        union_data->types.kodi_addon_pvr.v1.get_providers_amount(union_data->hdl, amount);
  }
  return auto_gen_ret;
}
    ...
    KODI_ADDON_PVR_TRANSFER_HDL handle) // Added with API 1
{
  ...
  UnionAddonFunctions* union_data = reinterpret_cast<UnionAddonFunctions*>(hdl);
  enum PVR_ERROR auto_gen_ret = PVR_ERROR_NO_ERROR;
  if (union_data->types.kodi_addon_pvr.v1.get_providers)
  {
    auto_gen_ret = union_data->types.kodi_addon_pvr.v1.get_providers(union_data->hdl, handle);
  }
  return auto_gen_ret;
}
...
{
  // Original API call: ATTR_DLL_EXPORT int kodi_addon_pvr_get_epg_max_future_days(KODI_ADDON_INSTANCE_BACKEND_HDL hdl) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT int kodi_addon_pvr_get_epg_max_past_days(KODI_ADDON_INSTANCE_BACKEND_HDL hdl) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_add_menu_hook(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const struct PVR_MENUHOOK* hook) __INTRODUCED_IN_KODI(1);
...
ATTR_DLL_EXPORT void kodi_addon_pvr_recording_notification(KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                           ...
                                                           bool on)
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_recording_notification(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const char* name, const char* fileName, bool on) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_connection_state_change(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const char* strConnectionString, enum PVR_CONNECTION_STATE newState, const char* strMessage) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_epg_event_state_change(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, struct EPG_TAG* tag, enum EPG_EVENT_STATE newState) __INTRODUCED_IN_KODI(1);
...
ATTR_DLL_EXPORT void kodi_addon_pvr_transfer_channel_entry(KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                           const KODI_ADDON_PVR_TRANSFER_HDL handle,
                                                           const struct PVR_CHANNEL* chan)
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_transfer_channel_entry( KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const KODI_ADDON_PVR_TRANSFER_HDL handle, const struct PVR_CHANNEL* chan) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_transfer_provider_entry( KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const KODI_ADDON_PVR_TRANSFER_HDL handle, const struct PVR_PROVIDER* chanProvider) __INTRODUCED_IN_KODI(1);
  ...
  if (hdl == nullptr || handle == nullptr || chanProvider == nullptr)
    return;
  ...
  {
    msgpack::sbuffer in;
    msgpack::pack(in, msgParent__IN_kodi_addon_pvr_transfer_provider_entry_v1(
                          PtrValue(hdl), PtrValue(handle), chanProvider));
    AddonIfc::g_ifc->control->GetThreadIfc()->SendMessage(
        funcGroup_addoninstance_pvr_h, funcParent_kodi_addon_pvr_transfer_provider_entry_v1, in);
    return;
  }
#endif /* !KODI_INHIBIT_SHARED */

  const auto& auto_gen_group = AddonIfc::g_ifc->direct->to_kodi.addoninstance_pvr_h;
  auto_gen_group.kodi_addon_pvr_transfer_provider_entry_v1(auto_gen_group.thisClassHdl, hdl, handle,
                                                           chanProvider);
}

ATTR_DLL_EXPORT void kodi_addon_pvr_transfer_channel_group(KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                           const KODI_ADDON_PVR_TRANSFER_HDL handle,
                                                           const struct PVR_CHANNEL_GROUP* group)
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_transfer_channel_group( KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const KODI_ADDON_PVR_TRANSFER_HDL handle, const struct PVR_CHANNEL_GROUP* group) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_transfer_channel_group_member( KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const KODI_ADDON_PVR_TRANSFER_HDL handle, const struct PVR_CHANNEL_GROUP_MEMBER* member) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_transfer_epg_entry(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const KODI_ADDON_PVR_TRANSFER_HDL handle, const struct EPG_TAG* epgentry) __INTRODUCED_IN_KODI(1);
...
ATTR_DLL_EXPORT void kodi_addon_pvr_transfer_recording_entry(
    ...
    const struct PVR_RECORDING* recording)
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_transfer_recording_entry( KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const KODI_ADDON_PVR_TRANSFER_HDL handle, const struct PVR_RECORDING* recording) __INTRODUCED_IN_KODI(1);
...
ATTR_DLL_EXPORT void kodi_addon_pvr_transfer_timer_entry(KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                         ...
                                                         const struct PVR_TIMER* timer)
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_transfer_timer_entry(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const KODI_ADDON_PVR_TRANSFER_HDL handle, const struct PVR_TIMER* timer) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_trigger_channel_update(KODI_ADDON_INSTANCE_BACKEND_HDL hdl) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_trigger_providers_update(KODI_ADDON_INSTANCE_BACKEND_HDL hdl) __INTRODUCED_IN_KODI(1);
  ...
  {
    msgpack::sbuffer in;
    msgpack::pack(in, msgParent__IN_kodi_addon_pvr_trigger_providers_update_v1(PtrValue(hdl)));
    AddonIfc::g_ifc->control->GetThreadIfc()->SendMessage(
        funcGroup_addoninstance_pvr_h, funcParent_kodi_addon_pvr_trigger_providers_update_v1, in);
    return;
  }
#endif /* !KODI_INHIBIT_SHARED */

  const auto& auto_gen_group = AddonIfc::g_ifc->direct->to_kodi.addoninstance_pvr_h;
  auto_gen_group.kodi_addon_pvr_trigger_providers_update_v1(auto_gen_group.thisClassHdl, hdl);
}

ATTR_DLL_EXPORT void kodi_addon_pvr_trigger_channel_groups_update(
    KODI_ADDON_INSTANCE_BACKEND_HDL hdl)
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_trigger_channel_groups_update( KODI_ADDON_INSTANCE_BACKEND_HDL hdl) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_trigger_epg_update(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, unsigned int iChannelUid) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_trigger_recording_update(KODI_ADDON_INSTANCE_BACKEND_HDL hdl) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_pvr_trigger_timer_update(KODI_ADDON_INSTANCE_BACKEND_HDL hdl) __INTRODUCED_IN_KODI(1);
