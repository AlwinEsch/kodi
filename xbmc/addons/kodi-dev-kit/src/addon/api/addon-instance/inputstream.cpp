...
ATTR_DLL_EXPORT struct DEMUX_PACKET* kodi_addon_inputstream_allocate_demux_packet(
    KODI_ADDON_INSTANCE_BACKEND_HDL hdl, int data_size)
{
  // Original API call: ATTR_DLL_EXPORT struct DEMUX_PACKET* kodi_addon_inputstream_allocate_demux_packet( KODI_ADDON_INSTANCE_BACKEND_HDL hdl, int data_size) __INTRODUCED_IN_KODI(1);
  if (hdl == nullptr)
    return nullptr;
...
{
  // Original API call: ATTR_DLL_EXPORT struct DEMUX_PACKET* kodi_addon_inputstream_allocate_encrypted_demux_packet( KODI_ADDON_INSTANCE_BACKEND_HDL hdl, unsigned int data_size, unsigned int encrypted_subsample_count) __INTRODUCED_IN_KODI(1);
  if (hdl == nullptr)
    return nullptr;
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_inputstream_free_demux_packet(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, struct DEMUX_PACKET* packet) __INTRODUCED_IN_KODI(1);
