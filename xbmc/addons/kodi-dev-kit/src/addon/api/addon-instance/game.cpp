...
void CHdl_kodi_addoninstance_game_h::InitDirect(directFuncToAddon_addoninstance_game_h* ifcToAddon)
{
  ...
  ifcToAddon->kodi_addon_game_rc_generate_hash_from_file_v1 =
      kodi_addon_game_rc_generate_hash_from_file_v1;
  ifcToAddon->kodi_addon_game_rc_get_game_id_url_v1 = kodi_addon_game_rc_get_game_id_url_v1;
  ifcToAddon->kodi_addon_game_rc_get_patch_file_url_v1 = kodi_addon_game_rc_get_patch_file_url_v1;
  ifcToAddon->kodi_addon_game_rc_post_rich_presence_url_v1 =
      kodi_addon_game_rc_post_rich_presence_url_v1;
  ifcToAddon->kodi_addon_game_rc_enable_rich_presence_v1 =
      kodi_addon_game_rc_enable_rich_presence_v1;
  ifcToAddon->kodi_addon_game_rc_get_rich_presence_evaluation_v1 =
      kodi_addon_game_rc_get_rich_presence_evaluation_v1;
  ifcToAddon->kodi_addon_game_rc_reset_runtime_v1 = kodi_addon_game_rc_reset_runtime_v1;
}
...
enum GAME_ERROR CHdl_kodi_addoninstance_game_h::kodi_addon_game_rc_generate_hash_from_file_v1(
    ...
    const char* file_path) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_game_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return GAME_ERROR_NO_ERROR;
  ...
  UnionAddonFunctions* union_data = reinterpret_cast<UnionAddonFunctions*>(hdl);
  enum GAME_ERROR auto_gen_ret = GAME_ERROR_NO_ERROR;
  if (union_data->types.kodi_addon_game.v1.rc_generate_hash_from_file)
  {
    auto_gen_ret = union_data->types.kodi_addon_game.v1.rc_generate_hash_from_file(
        union_data->hdl, hash, console_id, file_path);
  }
  return auto_gen_ret;
}
...
enum GAME_ERROR CHdl_kodi_addoninstance_game_h::kodi_addon_game_rc_get_game_id_url_v1(
    ...
    const KODI_ADDON_GAME_HDL hdl,
    char** url,
    const char* hash) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_game_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return GAME_ERROR_NO_ERROR;
  ...
  UnionAddonFunctions* union_data = reinterpret_cast<UnionAddonFunctions*>(hdl);
  enum GAME_ERROR auto_gen_ret = GAME_ERROR_NO_ERROR;
  if (union_data->types.kodi_addon_game.v1.rc_get_game_id_url)
  {
    auto_gen_ret =
        union_data->types.kodi_addon_game.v1.rc_get_game_id_url(union_data->hdl, url, hash);
  }
  return auto_gen_ret;
}
...
enum GAME_ERROR CHdl_kodi_addoninstance_game_h::kodi_addon_game_rc_get_patch_file_url_v1(
    ...
    const char* username,
    const char* token,
    unsigned int game_id) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_game_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return GAME_ERROR_NO_ERROR;
  ...
  UnionAddonFunctions* union_data = reinterpret_cast<UnionAddonFunctions*>(hdl);
  enum GAME_ERROR auto_gen_ret = GAME_ERROR_NO_ERROR;
  if (union_data->types.kodi_addon_game.v1.rc_get_patch_file_url)
  {
    auto_gen_ret = union_data->types.kodi_addon_game.v1.rc_get_patch_file_url(
        union_data->hdl, url, username, token, game_id);
  }
  return auto_gen_ret;
}
...
enum GAME_ERROR CHdl_kodi_addoninstance_game_h::kodi_addon_game_rc_post_rich_presence_url_v1(
    ...
    const char* rich_presence) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_game_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return GAME_ERROR_NO_ERROR;
  ...
  UnionAddonFunctions* union_data = reinterpret_cast<UnionAddonFunctions*>(hdl);
  enum GAME_ERROR auto_gen_ret = GAME_ERROR_NO_ERROR;
  if (union_data->types.kodi_addon_game.v1.rc_post_rich_presence_url)
  {
    auto_gen_ret = union_data->types.kodi_addon_game.v1.rc_post_rich_presence_url(
        union_data->hdl, url, post_data, username, token, game_id, rich_presence);
  }
  return auto_gen_ret;
}

enum GAME_ERROR CHdl_kodi_addoninstance_game_h::kodi_addon_game_rc_enable_rich_presence_v1(
    void* thisClassHdl, const KODI_ADDON_GAME_HDL hdl, const char* script) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_game_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return GAME_ERROR_NO_ERROR;
  ...
  UnionAddonFunctions* union_data = reinterpret_cast<UnionAddonFunctions*>(hdl);
  enum GAME_ERROR auto_gen_ret = GAME_ERROR_NO_ERROR;
  if (union_data->types.kodi_addon_game.v1.rc_enable_rich_presence)
  {
    auto_gen_ret =
        union_data->types.kodi_addon_game.v1.rc_enable_rich_presence(union_data->hdl, script);
  }
  return auto_gen_ret;
}
...
enum GAME_ERROR CHdl_kodi_addoninstance_game_h::kodi_addon_game_rc_get_rich_presence_evaluation_v1(
    ...
    const KODI_ADDON_GAME_HDL hdl,
    char** evaluation,
    unsigned int console_id) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_game_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return GAME_ERROR_NO_ERROR;
  ...
  UnionAddonFunctions* union_data = reinterpret_cast<UnionAddonFunctions*>(hdl);
  enum GAME_ERROR auto_gen_ret = GAME_ERROR_NO_ERROR;
  if (union_data->types.kodi_addon_game.v1.rc_get_rich_presence_evaluation)
  {
    auto_gen_ret = union_data->types.kodi_addon_game.v1.rc_get_rich_presence_evaluation(
        union_data->hdl, evaluation, console_id);
  }
  return auto_gen_ret;
}
    ...
    void* thisClassHdl, const KODI_ADDON_GAME_HDL hdl) // Added with API 1
{
  ...
  UnionAddonFunctions* union_data = reinterpret_cast<UnionAddonFunctions*>(hdl);
  enum GAME_ERROR auto_gen_ret = GAME_ERROR_NO_ERROR;
  if (union_data->types.kodi_addon_game.v1.rc_reset_runtime)
  {
    auto_gen_ret = union_data->types.kodi_addon_game.v1.rc_reset_runtime(union_data->hdl);
  }
  return auto_gen_ret;
}
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_game_close(KODI_ADDON_INSTANCE_BACKEND_HDL hdl) __INTRODUCED_IN_KODI(1);
  if (hdl == nullptr)
    return;
...
{
  // Original API call: ATTR_DLL_EXPORT KODI_GAME_STREAM_HANDLE kodi_addon_game_open_stream( KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const struct game_stream_properties* properties) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT bool kodi_addon_game_get_stream_buffer(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, KODI_GAME_STREAM_HANDLE game_hdl, unsigned int width, unsigned int height, struct game_stream_buffer* buffer) __INTRODUCED_IN_KODI(1);
...
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_game_add_stream_data(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, KODI_GAME_STREAM_HANDLE game_hdl, const struct game_stream_packet* packet) __INTRODUCED_IN_KODI(1);
...
ATTR_DLL_EXPORT void kodi_addon_game_release_stream_buffer(KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                           ...
                                                           struct game_stream_buffer* buffer)
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_game_release_stream_buffer(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, KODI_GAME_STREAM_HANDLE game_hdl, struct game_stream_buffer* buffer) __INTRODUCED_IN_KODI(1);
  if (hdl == nullptr || game_hdl == nullptr || buffer == nullptr)
    return;
...
ATTR_DLL_EXPORT void kodi_addon_game_close_stream(KODI_ADDON_INSTANCE_BACKEND_HDL hdl,
                                                  KODI_GAME_STREAM_HANDLE game_hdl)
{
  // Original API call: ATTR_DLL_EXPORT void kodi_addon_game_close_stream(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, KODI_GAME_STREAM_HANDLE game_hdl) __INTRODUCED_IN_KODI(1);
...
ATTR_DLL_EXPORT game_proc_address_t
kodi_addon_game_hw_get_proc_address(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const char* symbol)
{
  // Original API call: ATTR_DLL_EXPORT game_proc_address_t kodi_addon_game_hw_get_proc_address( KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const char* symbol) __INTRODUCED_IN_KODI(1);
  if (hdl == nullptr || symbol == nullptr)
    return nullptr;

  const auto& auto_gen_group = AddonIfc::g_ifc->direct->to_kodi.addoninstance_game_h;
  return auto_gen_group.kodi_addon_game_hw_get_proc_address_v1(auto_gen_group.thisClassHdl, hdl,
                                                               symbol);
}
...
{
  // Original API call: ATTR_DLL_EXPORT bool kodi_addon_game_input_event(KODI_ADDON_INSTANCE_BACKEND_HDL hdl, const struct game_input_event* event) __INTRODUCED_IN_KODI(1);
