...
public:
  ...
  static KODI_ADDON_GAME_HDL kodi_addon_game_create_v1(
  ...
  static enum GAME_ERROR kodi_addon_game_rc_generate_hash_from_file_v1(
      void* thisClassHdl,
      const KODI_ADDON_GAME_HDL hdl,
      char** hash,
  ...
  static enum GAME_ERROR kodi_addon_game_rc_get_game_id_url_v1(
      void* thisClassHdl,
      const KODI_ADDON_GAME_HDL hdl,
      char** url,
      const char* hash); // Added with API 1

  static enum GAME_ERROR kodi_addon_game_rc_get_patch_file_url_v1(
      void* thisClassHdl,
      const KODI_ADDON_GAME_HDL hdl,
      char** url,
      const char* username,
  ...
  static enum GAME_ERROR kodi_addon_game_rc_post_rich_presence_url_v1(
      void* thisClassHdl,
      const KODI_ADDON_GAME_HDL hdl,
      char** url,
      char** post_data,
  ...
  static enum GAME_ERROR kodi_addon_game_rc_enable_rich_presence_v1(
      void* thisClassHdl, const KODI_ADDON_GAME_HDL hdl, const char* script); // Added with API 1

  static enum GAME_ERROR kodi_addon_game_rc_get_rich_presence_evaluation_v1(
      void* thisClassHdl,
      const KODI_ADDON_GAME_HDL hdl,
      char** evaluation,
      unsigned int console_id); // Added with API 1

  static enum GAME_ERROR kodi_addon_game_rc_reset_runtime_v1(
      void* thisClassHdl, const KODI_ADDON_GAME_HDL hdl); // Added with API 1
};
