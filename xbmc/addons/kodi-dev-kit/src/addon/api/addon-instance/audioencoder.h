...
class ATTR_DLL_LOCAL CHdl_kodi_addoninstance_audioencoder_h : public IMsgHdl
{
public:
  CHdl_kodi_addoninstance_audioencoder_h(AddonIfc* ifc) : IMsgHdl(ifc) {}

  void InitDirect(
      KODI::ADDONS::INTERFACE::directFuncToAddon_addoninstance_audioencoder_h* ifcToAddon);
  ...
  static bool kodi_addon_audioencoder_start_v1(
      void* thisClassHdl,
      KODI_ADDON_AUDIOENCODER_HDL hdl,
      const struct KODI_ADDON_AUDIOENCODER_INFO_TAG* tag); // Added with API 1

  static ssize_t kodi_addon_audioencoder_encode_v1(void* thisClassHdl,
                                                   KODI_ADDON_AUDIOENCODER_HDL hdl,
                                                   const uint8_t* pbt_stream,
                                                   size_t num_bytes_read); // Added with API 1

  static bool kodi_addon_audioencoder_finish_v1(
