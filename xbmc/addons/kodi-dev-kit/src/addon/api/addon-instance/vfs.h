...
public:
  ...
  static bool kodi_addon_vfs_file_io_control_set_cache_rate_v1(void* thisClassHdl,
                                                               const KODI_ADDON_VFS_HDL hdl,
                                                               KODI_VFS_FILE_HDL context,
  ...
  static void kodi_addon_vfs_clear_out_idle_v1(void* thisClassHdl,
                                               const KODI_ADDON_VFS_HDL hdl); // Added with API 1
  ...
  static bool kodi_addon_vfs_directory_exists_v1(
      void* thisClassHdl,
      const KODI_ADDON_VFS_HDL hdl,
      const struct KODI_ADDON_VFS_URL* url); // Added with API 1

  static bool kodi_addon_vfs_directory_remove_v1(
      void* thisClassHdl,
      const KODI_ADDON_VFS_HDL hdl,
      const struct KODI_ADDON_VFS_URL* url); // Added with API 1

  static bool kodi_addon_vfs_directory_create_v1(
      void* thisClassHdl,
      const KODI_ADDON_VFS_HDL hdl,
      const struct KODI_ADDON_VFS_URL* url); // Added with API 1
