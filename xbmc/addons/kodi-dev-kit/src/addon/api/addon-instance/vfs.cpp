...
KODI_VFS_FILE_HDL CHdl_kodi_addoninstance_vfs_h::kodi_addon_vfs_file_open_v1(
    ...
    const struct KODI_ADDON_VFS_URL* url) // Added with API 1
{
...
bool CHdl_kodi_addoninstance_vfs_h::kodi_addon_vfs_file_close_v1(
    void* thisClassHdl, const KODI_ADDON_VFS_HDL hdl, KODI_VFS_FILE_HDL context) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_vfs_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return false;
...
void CHdl_kodi_addoninstance_vfs_h::kodi_addon_vfs_clear_out_idle_v1(
    void* thisClassHdl, const KODI_ADDON_VFS_HDL hdl) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_vfs_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return;
...
bool CHdl_kodi_addoninstance_vfs_h::kodi_addon_vfs_rename_v1(
    ...
    const KODI_ADDON_VFS_HDL hdl,
    const struct KODI_ADDON_VFS_URL* url,
    const struct KODI_ADDON_VFS_URL* url2) // Added with API 1
{
  auto thisClass = reinterpret_cast<CHdl_kodi_addoninstance_vfs_h*>(thisClassHdl);
  if (thisClass == nullptr)
    return false;
