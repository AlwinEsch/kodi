...
public:
  ...
  static enum ADDON_STATUS kodi_addon_create_v1(
      void* thisClassHdl,
  ...
  static enum ADDON_STATUS kodi_addon_create_instance_v1(
      void* thisClassHdl,
      const KODI_ADDON_HDL hdl,
  ...
  static enum ADDON_STATUS kodi_addon_instance_setting_change_string_v1(
      void* thisClassHdl,
      const KODI_ADDON_HDL hdl,
  ...
  static enum ADDON_STATUS kodi_addon_instance_setting_change_boolean_v1(
      void* thisClassHdl,
      const KODI_ADDON_HDL hdl,
      const KODI_ADDON_INSTANCE_HDL instance_hdl,
      const char* name,
  ...
  static enum ADDON_STATUS kodi_addon_instance_setting_change_integer_v1(
      void* thisClassHdl,
      const KODI_ADDON_HDL hdl,
      const KODI_ADDON_INSTANCE_HDL instance_hdl,
      const char* name,
  ...
  static enum ADDON_STATUS kodi_addon_instance_setting_change_float_v1(
      void* thisClassHdl,
      const KODI_ADDON_HDL hdl,
      const KODI_ADDON_INSTANCE_HDL instance_hdl,
      const char* name,
  ...
  static KODI_ADDON_INSTANCE_HDL kodi_addon_instance_create_v1(
      void* thisClassHdl, KODI_ADDON_INSTANCE_BACKEND_HDL kodi_hdl); // Added with API 1

  static void kodi_addon_instance_destroy_v1(void* thisClassHdl,
                                             KODI_ADDON_INSTANCE_HDL hdl); // Added with API 1
};
